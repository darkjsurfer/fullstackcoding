     ...
     while($row = $result->fetch_assoc()) {
              ...
              echo "<br><div class='itemname'>" . $row["ProductName"] . " </div>
                        ...
                        <div class='itemdescription'>" .$row["ProductDesc"] . "</div>
                              ...
                              <div class='itemprice'> Glass $" .$row["PriceGlass"]. ".00 </div>";
   }
} else {
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
 ...
 echo "<br><div class='itemname'>" . $row["ProductName"] . " </div>
                        ...
                        <div class='itemdescription'>" .$row["ProductDesc"] . "</div>
                              ...
                              <div class='itemprice'>$" .$row["Price"]. ".00 </div>"; echo "<br> <input type='checkbox'><div class='idname'>id: ". $row["id"]. "</div> Name: ". $row["CategoryName"]. " " . $row["ProductName"] . " " .$row["ProductDesc"] . " " .$row["Price"]. " " .$row["DateCreated"]. "<br>";
